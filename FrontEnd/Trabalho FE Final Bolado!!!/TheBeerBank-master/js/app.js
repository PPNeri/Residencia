...
'<img class="modal-img-footer" src="https://images.punkapi.com/v2/101.png" class="img-fluid" alt="Responsive image">'+
'</div>'+
'<div class="card " id="alsolikecard">'+
'<img class="modal-img-footer" src="https://images.punkapi.com/v2/103.png" class="img-fluid" alt="Responsive image">'+
'</div>'+
'<div class="card " id="alsolikecard">'+
'<img class="modal-img-footer" src="https://images.punkapi.com/v2/105.png" class="img-fluid" alt="Responsive image">'+
'</div>'+
'</div>'+
'</div>'+
'</div>'+
