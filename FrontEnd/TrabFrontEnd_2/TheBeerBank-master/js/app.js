...
//-------------------FIM CABEÇARIO MODAL
//-------------------INICIO BODY
'<h5 class="modal-title" style="color:darkorange">'+value.name+'</h5>'+
'<div class="modal-subtitle" style="color:gray">'+value.tagline+'</div>'+
'<img class="modal-img-big" src="'+value.image_url+'" class="img-fluid" alt="Responsive image">'+
...
'<div class="modal-body" style="color:gray;text-align:left"><strong>Best Serverd With:</strong></div>'+
'<div class="modal-body" style="color:gray">'+
'<ul style=text-align:left>'+
'<li>'+value.food_pairing[0]+'</li>'+
'<li>'+value.food_pairing[1]+'</li>'+
'<li>'+value.food_pairing[2]+'</li>'+
'</ul>'+
//------------------FIM BODY
//------------------INICIO FOOTER

'<div class="modal-footer">'+
'<h4 class ="title ml-6 mt-5" id="alsolike">You might also like:</h4>'+
'</div>'+
'<li class="card " id="alsolikecard">'+
'<img class="modal-img-footer" src="'+value.image_url+'" class="img-fluid" alt="Responsive image">'+
...
'</div>'+
'<li class="card " id="alsolikecard">'+
'<img class="modal-img-footer" src="https://images.punkapi.com/v2/27.png" class="img-fluid" alt="Responsive image">'+
'<div class="card-body" id="alsolikecard">'+
'<h5 class="card-title" style="color: grey">'+value.name+'</h5>'+
'</div>'+
'</li>'+
'<li class="card " id="alsolikecard">'+
'<img class="modal-img-footer" src="https://images.punkapi.com/v2/25.png" class="img-fluid" alt="Responsive image">'+
'<div class="card-body" id="alsolikecard">'+
'<h5 class="card-title" style="color: grey"></h5>'+
'</div>'+
'</li>'+
'<li class="card " id="alsolikecard">'+
'<img class="modal-img-footer" src="https://images.punkapi.com/v2/30.png" class="img-fluid" alt="Responsive image">'+
'<div class="card-body" id="alsolikecard">'+
'<h5 class="card-title" style="color: grey">'+value.name+'</h5>'+
'</div>'+
'</li>'+
...
/*var todasCervas = [];
async function carregacervejas(){

  for(let i = 1; i<6;i++){
    fetch(´astgd8yasgdoyugasudigasyudgyuasgdg${i}´)
    .then(function(req,res){
      return res.json();
    })
    .then(function(data){
      todasCervas.push(...data)
    })
    
  }
  return EscreveTela(todasCervas)
}*/